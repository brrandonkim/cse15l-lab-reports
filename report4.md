...
From my Macbook, I had the login command copied onto my clipboard and used the paste command, `cmd-v`, to quickly have the command on terminal and hit `enter`, prompting me to my password. Then I typed in my personal password and hit `enter` to log into my ieng6 account.
